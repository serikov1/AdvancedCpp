...
execute_process(
  COMMAND "/usr/bin/git" show-ref "703bd9caab50b139428cea1aaff9974ebee5742e"
  WORKING_DIRECTORY "/home/vasilli/CLionProjects/AdvancedC++/secondLesson/cmake-build-debug-event-trace/_deps/googletest-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "703bd9caab50b139428cea1aaff9974ebee5742e")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("703bd9caab50b139428cea1aaff9974ebee5742e" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/703bd9caab50b139428cea1aaff9974ebee5742e")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/vasilli/CLionProjects/AdvancedC++/secondLesson/cmake-build-debug-event-trace/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/vasilli/CLionProjects/AdvancedC++/secondLesson/cmake-build-debug-event-trace/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
